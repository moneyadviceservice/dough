      ...
      describe Validation do
        ...
        describe :errors_for do
          it 'lists all errors for the field' do
            expect(tidy_markup(subject.errors_for(model, :field_one))).to eql("<ol id=\"field_one-errors\"><li>2. Field one field_one error A</li><li>3. Field one field_one error B</li></ol>")

            expect(tidy_markup(subject.errors_for(model, :field_two))).to eql("<ol id=\"field_two-errors\"><li>4. Field two field_two error A</li></ol>")
          end
        end
