describe('Validation', function() {
  ...
  describe('MinLength and NonEmpty', function() {
    beforeEach(function(done) {
      var self = this;
      requirejs(
          ['jquery', 'Validation'],
  ...
  // Not required, but if present, validate length check
  describe('MinLength not required', function() {
    beforeEach(function(done) {
      var self = this;
      requirejs(
          ['jquery', 'Validation'],
          function($, Validation) {
            self.$html = $(window.__html__['test/fixtures/Validation/MinLengthNotRequired.html']).appendTo('body');
            self.component = self.$html.find('[data-dough-component="Validation"]');
            self.Validation = Validation;
            done();
          }, done);
    ...
    it('should NOT show an inline error if left empty on blur', function() {

    });

    it('should NOT show the validation summary if left empty on submit', function() {
    ...
    it('should allow the form to submit if the value is empty OR has enough characters', function() {
